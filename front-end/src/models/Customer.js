...
/*
  ...
  máxima em que o cliente pode ter nascido para ter, pelo menos, 18
  anos na data de hoje.
*/
...
export default z.object({
  ...
  fullname: 
    z.string()
    .min(5,{ message: 'O nome deve ter, no mínimo, 5 caracters' })
  ...
  phone: 
    ...
    // Depois de um transform(), não podemos mais usar length(). Por isso, precisamos
    // usar uma função personalizada com refine() para validar o tamanho do campo
    .refine(val => val.length === 15, { message: 'O número de telefone/celular está incompleto' }),
