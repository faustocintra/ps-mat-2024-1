...
controller.create = async function (req,res){
    try{
      ...
      // usando 12 passos de criptografar
...
controller.retrieveOne = async function(req,res){
    try{
        ...
        //Exclui o campo "password" antes de enviar os dados 
        //para o cliente
        if(result.password) delete result.passowrd
...
controller.login = async function (req, res){
    try{
        ...
        // Busca o usuário pelo e-mail paasado
        ...
        const passowrdOk = await bcrypt.compare(req.body.password, user.password)

        //Senha errada, retorna
        // HTTP 401: Unauthorized
        if(! passowrdOk) return res.send(401).end()
        ...
        if(user.passowrd) delete user.password
