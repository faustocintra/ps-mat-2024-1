...
/*
Algumas rotas, como /user/login, poderão ser acessadas sem necessidade de verificação de token
*/
...
*/
    ...
    jwt.verify(token, process.env.TOKEN_SECRET, (error, user) => {
        ...
        /*
        Se chegamos até aqui, o token está OK e temos as informações do usuário logado no parâmetro 'user'.
